        ...
        <section>
            ...
            if(isset($_GET['update'])):
                ...
                if($_GET['update'] == "false"){
                    ...
                    echo "<h3 style='margin-bottom:2%;'>You were successfully removed!</h3>";
                }

            endif;
            if(isset($_GET['undefined'])):
                if($_GET['undefined'] == "true"){
                    echo "<h3 style='margin-bottom:2%;'>An error occurred in your deletion. Please make sure you are enrolled in that subject</h3>";
                }
            endif;
            ?>
            <form action="scripts/Cancellation.php" method="POST" onsubmit="return check()">
