    ...
    <div class="container">
        ...
        <section>
            <?php if(!isset($_POST['school-go'])): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <p>Please type in the name of the school you wish to see the departments of</p>
                    </div>
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <input type="submit" name='school-go' class="btn btn-primary" value="Search Department" />
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $result = check_schools($_POST['school-name']);
                            ?>

                                <?php if(empty($result)): ?>
                                    <p>No results matched</p>
                                    <p><a href="http://isit.local/ass5/departments.php">Perform a new search</a></p>
                                <?php else: ?>
                                    ...
                                    <?php
                                        for($i = 0; $i < sizeof($result);$i++){
                                            echo "<tr>";
                                                echo "<td>" . $result[$i]['departmentname'] . "</td>";
                                            echo "</tr>";
                                        }
                                    ?>
                                    </tbody>
