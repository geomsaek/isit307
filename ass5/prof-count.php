...
<head>
    ...
    <title>Professor School Count</title>
...
<div class="container-fluid">
    <div class="container">
        <header>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3>Professor Count in each School</h3>
                </div>
                <div class="col-sm-6">
        ...
        <section>
            <?php if(!isset($_POST['school-go'])): ?>
                <div class="row">
                    <div class="col-sm-12">
                        <p>Please type in the school to find the number of professors</p>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                $result = prof_number($_POST['school-name']);
                                ?>

                                <?php if(empty($result)): ?>
                                    <p>No results matched</p>
                                    <p><a href="http://isit.local/ass5/prof-count.php">Perform a new search</a></p>
                                <?php else: ?>
